...
public:
    BankAccount(string n, int ac, double bal, string p)
        : name(n), accountNum(ac), balance(bal), pin(p) {}
...
public:
    void AddAccount(string name, int accountNum, double balance, string pin) {
        accounts.push_back(BankAccount(name, accountNum, balance, pin));
    }
...
int main() {
    ...
    do {
        ...
        case 1: {
            ...
            cin >> balance;
            cout << "\t\tSet a 4-digit PIN for this account: ";
            cin >> pin;
            if (pin.length() != 4) {
                cout << "\t\tPIN must be 4 digits. Try again!" << endl;
                break;
            }
            bank.AddAccount(name, accountNum, balance, pin);
        ...
        case 4: {
            ...
            if (account != NULL) {
                ...
                if (account->verifyPin(pin)) {
                    ...
                    cout << "\t\tInvalid PIN. Transaction Denied!" << endl;
                }
            } else {
